...
public class ExperimentViewMeasurement extends AppCompatActivity implements AddMeasurementTrialFragment.OnFragmentInteractionListener {
    ...
    private static RecordMeasurementTrial data;
    FirebaseFirestore fs;
    public static RecordMeasurementTrial getDataBase() {
        if (data == null) {
            data = new RecordMeasurementTrial();
        }
        return data;
    }
...
//        }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.hasChild(ExperimentName)){
                    ...
                    if (counter < experiment.getMinTrials()){
                        ...
                        Toast.makeText(ExperimentViewMeasurement.this,"This experiment needs at least "+min+" trials", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        ...
        stat_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent_s_M = new Intent(ExperimentViewMeasurement.this, Statistic_RecordMeasurementTrial.class);
...
//                Log.d("main activity","On item click to record trials");
                ...
                new AlertDialog.Builder(ExperimentViewMeasurement.this)
                        ...
                        .setPositiveButton("Ignore", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                trialDataList.remove(trial_measurement);
                                trialAdapter.notifyDataSetChanged();
